 ...
 */
public class NetworkBenchmarkManager {

    private static final String TAG = "NetworkBenchmarkManager";
    ...
    public static class BenchmarkResult {
        ...
        public BenchmarkResult(long pingMs, double downloadSpeedMbps) {
            this.pingMs = pingMs;
     ...
     */
    public static void runBenchmark(final BenchmarkCallback callback) {
        executor.execute(() -> {
            long ping = -1;
            double mbps = 0.0;
            ...
            try {
                ...
                if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                    ...
                    is.close();
                    long durationMs = System.currentTimeMillis() - speedStartTime;
                    if (durationMs > 0) {
