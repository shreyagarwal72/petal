...
public class NinjaWebViewClient extends WebViewClient {
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        if (!ninjaWebView.isIncognito() && ninjaWebView.isHistory() && ninjaWebView.getUrl() != null && !ninjaWebView.getUrl().trim().equalsIgnoreCase("about:blank") && !ninjaWebView.getUrl().trim().startsWith("about:") && !BrowserUnit.isHomePage(ninjaWebView.getUrl())) {
        ...
        com.petal.browser.accessibility.PetalAccessibilityEngine.applyCaretBrowsing(ninjaWebView, com.petal.browser.accessibility.PetalAccessibilityEngine.isCaretBrowsingEnabled(context));
